...
const LoginRedirect: React.FC<LoginRedirectProps> = () => {
  ...
  // Variables
  const { setDataFetched, setUser, setToken } = useStoreActions(
  ...
  return (
    <div className="flex bg-main-bg w-[100%] h-[100%] justify-center items-center flex-col">
      <div>
        <img src={logo} width="200px" alt="bifrost-logo" />
      </div>
      <div className="mt-4">
        <svg
          aria-hidden="true"
          className="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-accent"
          viewBox="0 0 100 101"
          fill="none"
